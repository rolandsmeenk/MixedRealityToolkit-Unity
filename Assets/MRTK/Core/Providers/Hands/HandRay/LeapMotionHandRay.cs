...
{
    public class LeapMotionHandRay : IHandRay
    {
        /// <inheritdoc />
        public Ray Ray
        {
        ...
        private const float DynamicPivotBaseY = -0.1f, DynamicPivotMultiplierY = 0f, DynamicPivotMinY = -0.6f, DynamicPivotMaxY = -0.2f;
        private const float DynamicPivotBaseX = 0.03f, DynamicPivotMultiplierX = 0f, DynamicPivotMinX = 0.08f, DynamicPivotMaxX = 0.15f;
        ...
        {
            // below head
            //Vector3 rayPivotPoint = headTransform.position + new Vector3(0, -0.1f, 0);
